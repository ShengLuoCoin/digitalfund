...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Digitalfund Core digitalfund-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  digitalfund-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitalfund transaction") + "\n" +
              "  digitalfund-tx [options] -create [commands]   " + _("Create hex-encoded digitalfund transaction") + "\n" +
              "\n";

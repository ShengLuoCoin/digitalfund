...
#if defined(NDEBUG)
# error "Digitalfund cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Digitalfund Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("digitalfund-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Digitalfund: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Digitalfund: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)

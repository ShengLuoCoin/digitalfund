...
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1468972800, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams() {
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "Created By zaobi.org .QQ:260682605 ,欢迎咨询!2016-7-20 8:00:00";
        ...
        genesis.nNonce   =  710403;

        hashGenesisBlock = genesis.GetHash();
        //// debug print
        if(hashGenesisBlock != uint256(" 0x9a79ce6ddeea872d452451ab70662279501f6976329a245605a29b1a23b75617")){
        ...
        assert(hashGenesisBlock == uint256(" 0x9a79ce6ddeea872d452451ab70662279501f6976329a245605a29b1a23b75617"));
        assert(genesis.hashMerkleRoot == uint256(" 0x31cb95141958f7b36fe6a3e5f08182ef9643e3caae58a4a48f8d5cba1d609d22"));

        vSeeds.push_back(CDNSSeedData("zaobi.org4","47.89.36.247"));
        vSeeds.push_back(CDNSSeedData("zaobi.org3","192.200.217.228"));
        vSeeds.push_back(CDNSSeedData("zaobi.org3","192.200.217.234"));
        vSeeds.push_back(CDNSSeedData("zaobi.org2","115.28.227.87"));
        vSeeds.push_back(CDNSSeedData("zaobi.org1","103.17.93.75"));
        vSeeds.push_back(CDNSSeedData("zaobi.org0","103.17.92.71"));
        ...
        vSeeds.push_back(CDNSSeedData("3zaobi.org", "dnsseed3.zaoabi.org"));
        ...
        // Digitalfund: Mainnet v2 enforced as of block 710k
...
public:
	...
	nDefaultPort = 23644;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("digitalfundtools.com", "testnet-seed.digitalfundtools.com"));
        ...
        // Digitalfund: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256(" 0x609bdc51c9d096bfff970db63005652ccdb7256e634a7c3fc91f726f5a52c717"));
        ...
        // Digitalfund: v2 enforced using Bitcoin's supermajority rule
